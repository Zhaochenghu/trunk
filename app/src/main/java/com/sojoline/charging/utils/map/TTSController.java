package com.sojoline.charging.utils.map;
  ...
  private InitListener mTtsInitListener = new InitListener() {
    ...
    public void onInit(int code) {
      ...
      if (code != ErrorCode.SUCCESS) {
        ToastUtils.getInstance(LvApplication.getContext()).makeTextShow("初始化失败,错误码：", IToast.LENGTH_SHORT);
//        CustomToast.makeText(mContext, "初始化失败,错误码：" + code, Toast.LENGTH_SHORT).show();
      } else {
...
//      e.printStackTrace();
//    }
//    String appid = appInfo.metaData.getString("com.amap.api.v2.apikey");
