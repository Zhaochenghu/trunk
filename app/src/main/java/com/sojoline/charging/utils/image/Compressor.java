package com.sojoline.charging.utils.image;
...
public class Compressor {
    ...
    public Compressor(Context context) {
        destinationDirectoryPath = LvAppUtils.getCommonImageSavePath(context);
        DebugLog.log("file: %s", destinationDirectoryPath);
    }
