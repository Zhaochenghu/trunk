...
import com.sojoline.charging.utils.CountDownTimerUtils;
import com.sojoline.charging.utils.ValidationUtils;
import com.sojoline.charging.views.base.LvBaseAppCompatActivity;
import com.sojoline.model.request.RegisterRequest;
import com.sojoline.presenter.register.RegisterContract;
import com.sojoline.presenter.register.RegisterPresenter;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.reg_bt_register:
                ...
                RegisterRequest request = new RegisterRequest(num, psd, captcha,"0001");
